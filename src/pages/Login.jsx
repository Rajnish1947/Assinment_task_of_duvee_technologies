      ...
      <div className="bg-white/10 backdrop-blur-xl p-8 rounded-2xl shadow-2xl w-full max-w-sm border border-white/20">
        ...
        <form onSubmit={handleLogin} className="space-y-4">
          ...
          <input
            ...
            className="w-full px-4 py-2 rounded-lg bg-white/20 text-black placeholder-gray-300 outline-none focus:ring-2 focus:ring-sky-400"
          ...
          <input
            ...
            className="w-full px-4 py-2 rounded-lg  text-black placeholder-gray-500 outline-none focus:ring-2 focus:ring-sky-400"
